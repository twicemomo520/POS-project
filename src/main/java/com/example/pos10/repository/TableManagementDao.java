...
public interface TableManagementDao extends JpaRepository <TableManagement, String> {
	...
	@Modifying
	@Transactional
	@Query(value = "INSERT INTO table_management (table_number, table_capacity) VALUES (?1, ?2)", nativeQuery = true)
	public int insertTableNumber(String tableNumber, int tableCapacity);
