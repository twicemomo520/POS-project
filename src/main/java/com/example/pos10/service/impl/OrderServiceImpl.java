...
/////////////////////////////////////////////準備中/////////////////////////////////////////////////////////
			...
			if (mealStatus.equals("準備中")) {
				...
				Optional<SearchOrderStatusVo>existingOrderOpt = preparingOrders.stream().filter(preparingOrder->
		            preparingOrder.getTableNumber().equals(tableNumber) && 
				...
				//如果有同一個tableNumber和orderId的資料，就取出那一桌資料
				 if (existingOrderOpt.isPresent()) {
					 ...
					 List<MealVo> mealList = existingOrder.getMealList();
						...
						Optional<MealVo>existingOrderMealIdOpt = mealList.stream().filter(meal->
						meal.getOrderMealId().equals(orderMealId)
			            ).findFirst();
						...
						//如果沒有相同orderMealId就創一個MealVo map的mealDetail然後把新的餐點MealDetailVo的東西放進去mealDetail裡
						else {
...
/////////////////////////////////////////////待送餐點/////////////////////////////////////////////////////////
			...
			if (mealStatus.equals("待送餐點")) {
				...
				//檢測有無同一個tableNumber和orderId的資料
				Optional<SearchOrderStatusVo>existingOrderOpt = undeliveredOrders.stream().filter(undeliveredOrder->
				undeliveredOrder.getTableNumber().equals(tableNumber) && 
...
/////////////////////////////////////////////已送達/////////////////////////////////////////////////////////
			...
			if (mealStatus.equals("已送達")) {
				...
				//檢測有無同一個tableNumber和orderId的資料
				Optional<SearchOrderStatusVo>existingOrderOpt = deliveredOrders.stream().filter(deliveredOrder->
				deliveredOrder.getTableNumber().equals(tableNumber) && 
